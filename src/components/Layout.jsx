...
import { ReusableDialog } from './ResuableDialog'
...
function Header() {
  ...
  return (
    ...
    >
      ...
      <Button onClick={() => setShowDialogBox(true)} className="ml-4">
        Sign Out
      </Button>
      <ReusableDialog
        showDialog={showDialogBox}
        title="Sign out of Codemancers"
        closeDialog={() => setShowDialogBox(false)}
        description="Are you sure you want to Sign out? A new sign-in will be required."
        nextActionText="Sign Out"
        nextActionClick={() => signOut()}
        cancelActionText="Cancel"
        cancelActionClick={() => setShowDialogBox(false)}
      />
    </header>
  )
}
